...
- See [clinics-spec.md](../features/clinics-spec.md) for full claim flow details.
...
Consolidated from `docs/partners/outreach-pipeline.md`.
...
Consolidated from `docs/partners/claim-verification-ops.md`.
...
Consolidated from `docs/partners/bulgaria-clinic-seeding-plan.md` and DECISIONS.md #8.
...
> **Note:** The `clinics` table already has a claim flow (see [clinics-spec.md](../features/clinics-spec.md)). The `partnerClaims` table extends this pattern to all partner types, not just clinics.
