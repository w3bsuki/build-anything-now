...
> Revenue model finalized — see `docs/references/business-ideation/monetization-spec.md` for full implementation details, data model additions, and open questions.
