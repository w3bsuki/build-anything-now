...
- i18n: Bulgarian language support live (see [i18n-spec.md](../../design-docs/ui/i18n-spec.md)).
...
- **i18n readiness:** Growth is gated on localization. No market entry without full app localization (see [i18n-spec.md](../../design-docs/ui/i18n-spec.md)).
