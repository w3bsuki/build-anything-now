...
- `docs/design-docs/ui/mobile-ux-audit-2026-02-07.md` (F1–F13, 5-phase remediation plan)
- `docs/design-docs/ui/localhost-8080-visual-audit.md` (P0 — presentation white-screen)
