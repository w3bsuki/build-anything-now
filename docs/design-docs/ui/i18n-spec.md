...
- `docs/design-docs/ui/mobile-ux-audit-2026-02-07.md` (F2 — 60+ missing keys, language soup)
- `docs/design-docs/ui/localhost-8080-visual-audit.md` (P1 — CORS failures from language detection)
