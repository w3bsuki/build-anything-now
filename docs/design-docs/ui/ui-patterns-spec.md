...
- `docs/design-docs/ui/localhost-8080-visual-audit.md` (P2 — home feed density)
- `docs/design-docs/ui/mobile-ux-audit-2026-02-07.md` (F12 — typography hierarchy, F13 — ambiguous FAB)
