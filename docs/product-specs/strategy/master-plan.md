...
|----------|---------|----------|
| Product Roadmap | Phased timeline and gates | `docs/product-specs/strategy/future-goals.md` |
| PRD | Product bible, feature checklist | `PRD.md` (root) |
| Feature Specs | Per-domain deep specs | `docs/product-specs/features/` |
| Mission Specs | Drone, safehouse, marketplace | `docs/product-specs/missions/` |
| System Specs | Data model, API, auth, deployment | `docs/design-docs/systems/` |
| Design Specs | Theming, UI patterns, mobile, i18n | `docs/design-docs/ui/` |
| Business Specs | Monetization, partners, growth | `docs/references/business-ideation/` |
| Partner Ops | Directory seeding, claims, outreach | `docs/references/partner-ideation/` |
