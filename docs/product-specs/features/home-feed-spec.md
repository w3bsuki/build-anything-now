...
See [ui-patterns-spec.md](../../design-docs/ui/ui-patterns-spec.md) for detailed first-fold structure and layout expectations.
...
4. **Search UX** — Search is currently inline in the feed query. Should it move to a dedicated search overlay? See [ui-patterns-spec.md](../../design-docs/ui/ui-patterns-spec.md#search-overlay).
