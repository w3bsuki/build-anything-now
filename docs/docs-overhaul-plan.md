...
- Merged duplicate `docs/product/prd.md` into root `PRD.md` (richer content preserved)
- Adopted 3-state checklist: `[x]` shipped, `[~]` partial, `[ ]` not started
- Deleted `docs/product/prd.md` (duplicate)
...
- Created `scripts/gen-feature-index.mjs` — auto-generates `docs/features/INDEX.md` from spec headers
...
- **Design system extension:** Added Component Catalog (22 shadcn primitives) and Accessibility Baseline (WCAG 2.1 AA) to `docs/design/ui-patterns-spec.md`
...
|--------|---------|-------|
| `scripts/gen-feature-index.mjs` | Auto-generate `docs/features/INDEX.md` from spec headers | `node scripts/gen-feature-index.mjs` |
...
| `docs/features/INDEX.md` | Auto-generated feature registry |
| `docs/features/activity-feed-spec.md` | Activity feed & stories spec |
| `docs/features/home-feed-spec.md` | Home feed & landing spec |
| `docs/features/pet-services-spec.md` | Pet services directory spec |
| `docs/features/social-spec.md` | Social interactions spec |

## Files Modified

| File | Changes |
|------|---------|
| `PRD.md` | Content merged from docs/product/prd.md, spec links added to checklist |
...
| `docs/design/ui-patterns-spec.md` | Component Catalog + Accessibility Baseline |
| `docs/product/master-plan.md` | Fixed docs-v2/ refs |
| `docs/investor/` (10 files) | Added headers, fixed broken refs |
...
| File | Reason |
|------|--------|
| `docs/product/prd.md` | Duplicate PRD (merged into root) |
| `docs/master_plan.md` | Orphan duplicate of `docs/product/master-plan.md` |
