...
- `docs/design/tailwind-shadcn-remediation-plan.md`
...
Issues identified from `refactor/tailwind.md` and `docs/design/tailwind-shadcn-remediation-plan.md`:
...
5. **Token drift:** Ensure `docs/design/theming-tokens-spec.md` stays in sync with `src/index.css` after token updates.
