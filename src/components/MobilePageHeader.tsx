          ...
          {searchPlaceholder && (
            <div className="relative">
              ...
              <input
                ...
                className="w-full rounded-full bg-muted/80 pl-10 pr-4 py-2 text-base text-foreground placeholder:text-muted-foreground transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background"
                value={searchValue}
